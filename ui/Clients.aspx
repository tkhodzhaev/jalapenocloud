<%@ Page Title="Jalapeno Cloud" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Clients.aspx.cs" Inherits="UI.Clients"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div style="text-align: center">
	    <div style="width: 100%; margin: 0 auto; text-align: left;">
            <h5 class="text-info"><asp:Label ID="lblGridHeader" runat="server" Text="Clients"></asp:Label></h5>
        </div>
    </div>

    <tru:PagingGrid ID="pgdData" runat="server" AutoGenerateColumns="true"
        AllowPaging="true" PagerSettings-Position="TopAndBottom" OnPageIndexChanged="pgdData_PageIndexChanged"
        HorizontalAlign="Center" GridLines="0" CssClass="table table-striped table-condensed"
