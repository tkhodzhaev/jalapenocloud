<%@ Page Title="Jalapeno Cloud" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="UI.Users"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div style="text-align: center">
	    <div style="width: 100%; margin: 0 auto; text-align: left;">
            <h5 class="text-info"><asp:Label ID="lblGridHeader" runat="server" Text="Users"></asp:Label></h5>
        </div>
    </div>
    ...
    <tru:PagingGrid ID="pgdData" runat="server" AutoGenerateColumns="true"
        ...
        <Columns>
            ...
            <asp:TemplateField ItemStyle-ForeColor="#0764B5" ItemStyle-Wrap="true" HeaderText="Clients">
                <ItemTemplate>
                    <asp:HyperLink ID="hplClients" runat="server" NavigateUrl='<%# Eval("Id","~/Clients.aspx?uid={0}") %>' Text="Clients"></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate>
